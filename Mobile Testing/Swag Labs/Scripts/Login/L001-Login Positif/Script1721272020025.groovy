...
Mobile.setText(findTestObject('Object Repository/Login/input_ Password'), password, 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.TextView - LOGIN'), 0)

if (close.toString().equals('1')) {
    Mobile.tap(findTestObject('Object Repository/Login/android.widget.TextView - PRODUCTS'), 0)
